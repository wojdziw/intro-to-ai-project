...
public class Population {
    ...
    public Population(int populationSize, boolean initialise, int noFeatures, double maxWeight, Integer[] subsetArray) {
        individuals = new Individual[populationSize];

        if (initialise)
            for (int i=0; i<size(); i++) {
                Individual newIndividual = new Individual(noFeatures, maxWeight, subsetArray);
